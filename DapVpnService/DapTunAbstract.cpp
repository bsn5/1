...
void DapTunAbstract::listenTunnel(int a_num)
{
    int *pInt = static_cast<int*>(::malloc(sizeof(int)));
    *pInt = a_num;
    ::pthread_create(&pidTun,NULL,DapTunAbstract::listenTunnelThread, pInt);
    StaticData* data = StaticData::me();
    data->setTun(this);
    QObject::connect(data,&StaticData::packetOut,this,&DapTunAbstract::packetOut);
}

void *DapTunAbstract::listenTunnelThread(void * arg)
{
...
void DapTunAbstract::initWorker()
{
  ...
  //  connect(tunWorker,&DapTunWorkerAbstract::loopStarted,this,&DapTunAbstract::onWorkerStarted);
...
void DapTunAbstract::workerStart(int sock)
{
